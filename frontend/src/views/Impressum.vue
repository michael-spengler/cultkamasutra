<template>
  <div class="view-impressum">
    ...
    <div content>
      ...
      <p>
        Quelle:
        <tc-link href="https://www.e-recht24.de/impressum-generator.html">
          e-recht24.de
        </tc-link>
      </p>

      <h2>Abmahnung</h2>
      <p><b>Keine Abmahnung ohne Kontakt! </b></p>
      <p>
        Sollte der Inhalt fremde Rechte Dritter oder gesetzliche Bestimmungen
        verletzen, informieren Sie mich ohne Kostennote. Ich garantiere, dass
        die zu Recht beanstandeten Passagen unverzüglich entfernt werden, ohne
        ...
        ausgelöste Kosten werden im Sinne der Schadensminderungspflicht
        zurückgewiesen und gegebenenfalls wird Gegenklage wegen Verletzung
